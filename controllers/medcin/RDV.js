...
const addRDV = async (req, res) => {
    ...
    if(!idu||!hopitale||!date)// il faut ajouter le medcin 
    {
    ...
    try {
     ...
     await Pool.query('INSERT INTO rdvs(date,hopital,id_user) VALUES($1,$2,$3)',[date,hopitale,idu]);/*il faut ajouter le medcin*/
