...
import { Searchpatient } from '../services/medcinservice';

export default function AccueilMedcin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        localStorage.setItem('patientId', patientData.id_user);
    ...
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <div style={styles.leftPane}>
          <h1 style={styles.greeting}>{greeting}, Docteur 👋</h1>
          <p style={styles.intro}>
            Entrez le CIN du patient pour consulter son dossier médical.
          </p>
          <img
            src="https://cdn.dribbble.com/users/240029/screenshots/14282926/media/c6158397ce0ee23d99f091c4e6d0f45b.png"
            alt="Recherche patient"
            style={styles.image}
          />
        </div>
