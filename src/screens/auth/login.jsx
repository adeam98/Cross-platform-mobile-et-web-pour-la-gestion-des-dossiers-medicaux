...
import { loginUser } from '../services/centreservice';

export default function CentreAnalyseLogin() {
  ...
  useEffect(() => {
    ...
    if (hour < 12) setGreeting("Bonjour au Centre d'analyse");
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (res.status !== 200) {
        alert('Identifiants invalides pour le Centre d\'analyse');
        return;
      }
      const data = res.data;
      ...
      <div style={styles.card}>
        <div style={styles.leftPane}>
          ...
          <p style={styles.brandSubtitle}>
            Accédez aux résultats de votre centre d'analyse.<br />Rapide. Fiable. Sécurisé.
          </p>
          <img
            ...
            alt="Analyse Centre Illustration"
            style={styles.image}
          />
        </div>

        <div style={styles.rightPane}>
          <h2 style={styles.formTitle}>Connexion Centre d'analyse</h2>
